...
extern void __CDECL enter(void);
extern void __CDECL bdos_trap2(void);
...
static long __CDECL ni(void);
static long __CDECL xgetver(void);
...
typedef struct
{
    union {
        long  (__CDECL *v)(void);
        long  (__CDECL *w)(short);
        long  (__CDECL *ww)(short, short);
        long  (__CDECL *www)(short, short, short);
        long  (__CDECL *wwww)(short, short, short, short);
        long  (__CDECL *wwwww)(short, short, short, short, short);
        long  (__CDECL *wwwwwww)(short, short, short, short, short, short, short);
    } fncall;
